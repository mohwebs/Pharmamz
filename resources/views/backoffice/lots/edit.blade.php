            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <form method="POST" action="{{url('admin/lots/'.$lot->id)}}" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input name="datefab" type="date" id="datefab" class="form-control{{ $errors->has('datefab') ? ' is-invalid' : '' }}" value="{{$lot->datefab}}" required autocomplete="datefab" autofocus>
                                                @error('datefab')
                                    ...
                                    <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input  name="dateper" type="date" id="dateper" class="form-control{{ $errors->has('dateper') ? ' is-invalid' : '' }}" value="{{$lot->dateper}}" required autocomplete="dateper" autofocus >
                                                    @error('dateper')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 ">
                                            <div class="form-group">
                                                <label>Prix</label>
                                            <input name="prix" type="text" class="form-control" value="{{$lot->prix}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input name="qtachete" type="text" class="form-control" value="{{$lot->qtachete}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Quantité Stock</label>
                                                <input name="qtstock" type="text" class="form-control" value="{{$lot->qtstock}}">
                                            </div>
                                        </div>
                                        <!--/span-->
